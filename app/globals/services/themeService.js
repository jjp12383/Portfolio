angular.module('portfolioApp')
  .service('themeService', function ($document, $firebaseArray, Ref) {
    ...
    var themes = $firebaseArray(Ref.child('admin').child('default').child('themes'));
      ...
      this.exStyle = function (el, styleProp, styleValue, nameSpace) {
        var element = el[0],
            currentStyle,
            ...
            for (var i = 0; i < document.styleSheets.length; i++) {
              ...
              do {
                ...
                if (cssRule && cssRule.selectorText)  {
                  if (cssRule.selectorText.toLowerCase().indexOf(ruleName) > 0 && cssRule.cssText.indexOf(styleProp + ': ' + currentStyle) > 0) {
                    ...
                    selector = selector.replace(/,/g, '.' + nameSpace + ',');
                    themes = [
                      {
                        themeClass: selector,
                        rules: [
